##############################################################################################
#' @title Parallel download all AOP files for a given site, year, and product
...
#' @param cores Number of cores to parallel download
...
ParallelFileAOP <- function(dpID, site="SJER", year="2017", check.size=TRUE, savepath=NA,cores=1) {
